...
IMPORTANT DETAIL: You may not use the arithmetic operatod when you think it is finished, uncomment the call for the testSumAndMultiply() function and see if the test passes.*/
...
function sumAndMultiply(a,b,c){
  ...
  return [
    ...
    'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + calculatedProduct + '.'
  ];
}
